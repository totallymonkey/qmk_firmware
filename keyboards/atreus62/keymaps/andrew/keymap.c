...
[_DEFAULT] = { /* Colemak */
		...
		{ KC_TAB,        KC_Q,    KC_W,    KC_F,    KC_P,     KC_B,    KC_TRNS,  KC_J,    KC_L,    KC_U,    KC_Y,    KC_SCLN, KC_BSLS },
		{ KC_LCTL,       KC_A,    KC_R,    KC_S,    KC_T,     KC_G,    KC_TRNS,  KC_H,    KC_N,    KC_E,    KC_I,    KC_O,    KC_QUOT },
		{ OSM(MOD_LSFT), KC_Z,    KC_X,    KC_C,    KC_D,     KC_V,    KC_DELT,  KC_K,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_EQL  },
